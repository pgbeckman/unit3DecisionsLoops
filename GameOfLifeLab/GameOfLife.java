...
public class GameOfLife
{
    ...
    private final int X2 = 1, Y2 = 3;
    private final int X3 = 2, Y3 = 2;
    private final int X4 = 3, Y4 = 2;
    private final int X5 = 3, Y5 = 3;
    public BoundedGrid<Actor> grid = null;
    ...
    public void createNextGeneration()
    {
        ...
        for( int x = 0 ; x < COLS ; x++ ) {
            for ( int y = 0 ; y < ROWS ; y++) {
                ...
                int neighborsNum = grid.getNeighbors(loc).size();
                if ( (this.getActor(x,y)!=null && neighborsNum==2) || neighborsNum==3) {
                    gridNew.put(loc,new Actor());
                }
            }
        }
